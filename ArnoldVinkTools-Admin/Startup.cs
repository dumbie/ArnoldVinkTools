    ...
    public partial class App : Application
    {
        ...
        protected override async void OnStartup(StartupEventArgs e)
        {
            try
            {
                ...
                SchTask_Name = "ArnoldVink_Tools";
                SchTask_Description = "AV Tools Administrator Helper";
                SchTask_FilePath = Path.GetDirectoryName(Assembly.GetEntryAssembly().Location) + "\\ArnoldVinkTools.exe";
