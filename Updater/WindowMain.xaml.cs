    ...
    public partial class WindowMain : Window
    {
        ...
        protected override async void OnSourceInitialized(EventArgs e)
        {
            try
            {
                ...
                foreach (Process CloseProcess in Process.GetProcessesByName("ArnoldVinkTools"))
                {
                    AppRunning = true;
                    CloseProcess.Kill();
                }
                ...
                try
                {
                    ...
                    Uri downloadUri = new Uri(ApiGitHub_GetDownloadPath("dumbie", "ArnoldVinkTools", "ArnoldVinkTools.zip"));
                ...
                if (AppRunning)
                {
                    ...
                    await ProcessLauncherWin32Async("ArnoldVinkTools-Admin.exe", "", "", true, false);
                }
